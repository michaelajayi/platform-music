...
export const musicPosts: IBlogPost[] = [
  {
    ...
    excerpt: "Discover how worship music serves as a bridge between the earthly and divine, transforming hearts and minds through spirit-filled melodies.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Learn practical strategies for developing, nurturing, and leading a unified music ministry team that serves with excellence and heart.",
    content: `
  ...
  },
  {
    ...
    title: "Gospel Music Production: Creating Professional Sounds in Your Home Studio",
    excerpt: "Master the art of gospel music production with practical tips for recording, mixing, and producing spirit-filled music from your home studio.",
    content: `
    ...
    readTime: 10,
    tags: ["Music Production", "Home Studio", "Gospel Music", "Audio Engineering"],
    category: "Production",
  },
  {
    id: "4",
    slug: "nurturing-young-voices-children-youth-choir-ministry",
    title: "Nurturing Young Voices: Building a Thriving Children and Youth Choir Ministry",
    excerpt: "Discover effective strategies for developing children and youth choir programs that foster both musical growth and spiritual development.",
    content: `
    ...
    readTime: 9,
    tags: ["Children's Ministry", "Youth Choir", "Music Education", "Worship Training"],
    category: "Education",
  },
  {
    id: "5",
    ...
    excerpt: "Learn how to select worship songs that engage your congregation, fit your church's style, and create meaningful worship experiences.",
    content: `
    ...
    readTime: 8,
    tags: ["Worship Leading", "Song Selection", "Congregational Worship", "Church Music"],
    category: "Worship",
  }
];